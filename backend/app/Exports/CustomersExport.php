...
class CustomersExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting, WithEvents
{
    use Exportable;
    ...
    public function view(): View
    {
        return view('exports.customers', [
            'models' => Customer::filter($this->filter)->orderBy('id', 'desc')->get()
        ]);
    }
