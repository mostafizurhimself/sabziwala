...
class OrdersExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting, WithEvents
{
    use Exportable;
    ...
    public function view(): View
    {
        return view('exports.orders', [
            'models' => Order::with('customer', 'rider', 'zone')->filter($this->filter)->orderBy('id', 'desc')->get()
        ]);
    }
