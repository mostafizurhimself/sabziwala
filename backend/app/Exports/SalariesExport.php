...
class SalariesExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting, WithEvents
{
    use Exportable;
    ...
    public function view(): View
    {
        return view('exports.salaries', [
            'models' => Salary::filter($this->filter)->orderBy('id', 'desc')->get()
        ]);
    }
