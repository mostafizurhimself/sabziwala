...
class RidersExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting, WithEvents
{
    use Exportable;
    ...
    {
        return view('exports.riders', [
            'models' => Rider::filter($this->filter)->orderBy('id', 'desc')->get()
        ]);
    }
