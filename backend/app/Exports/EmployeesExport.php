...
class EmployeesExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting, WithEvents
{
    use Exportable;
    ...
    public function view(): View
    {
        return view('exports.employees', [
            'models' => Employee::filter($this->filter)->orderBy('id', 'desc')->get()
        ]);
    }
