...
class ZonesExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting, WithEvents
{
    use Exportable;
    ...
    public function view(): View
    {
        return view('exports.zones', [
            'models' => Zone::withCount(['products', 'riders'])->filter($this->filter)->orderBy('id', 'desc')->get()
        ]);
    }
