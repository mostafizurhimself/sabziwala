    ...
    <div class="">
        <form @submit.prevent="save">
            ...
            <form-group class="border-b">
                ...
                <div class="w-full mt-1">
                    <jet-image-input :url="$page.props.aboutPageHero?.primaryMediaUrl" v-model="form.poster"></jet-image-input>
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                title: this.$page.props.aboutPageHero?.data?.title,
                poster: null,
            }),
        };
    },
    ...
    methods: {
        save() {
            this.form.post(route("appearance.about.hero"));
        },
    },
};
</script>
