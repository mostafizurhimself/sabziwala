    ...
    <div class="">
        <form @submit.prevent="save">
            ...
            <form-group class="border-b">
                ...
                <div class="w-full mt-1">
                    <jet-image-input :url="$page.props.riderApps?.primaryMediaUrl" v-model="form.image"></jet-image-input>
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                title: this.$page.props.riderApps?.data?.title,
                subtitle: this.$page.props.riderApps?.data?.subtitle,
                playStore: this.$page.props.riderApps?.data?.playStore,
                appStore: this.$page.props.riderApps?.data?.appStore,
                image: null,
            }),
        };
    },
    ...
    methods: {
        save() {
            this.form.post(route("appearance.rider.apps"));
        },
    },
};
</script>
