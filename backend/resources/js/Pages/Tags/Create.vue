<template>
	<form-view @submitted="save('tags.store')" title="Create Tag" :breadcrumb="breadcrumb">
		<template #form>
			<!-- Name -->
		...
		<template #actions>
			...
			<jet-button @click.prevent="save('tags.store', true)" class="px-6 xs:mr-2 my-2 xs:my-0" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Save & Continue</jet-button>
